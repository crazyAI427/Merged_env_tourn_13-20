...
_REGISTRY: dict[str, EnvTrainingConfig] = {
    ...
    "liars_dice_opponent_modeling": EnvTrainingConfig(
        ...
        reasoning=ModeConfig(rollouts_per_stage=2048, initial_max_turn=5),
        no_mask=ModeConfig(rollouts_per_stage=2048, initial_max_turn=5),
        full_prompt=ModeConfig(rollouts_per_stage=2048, initial_max_turn=5),
        num_generations=8,
        temperature=2.0,
        top_k=5,
    ),
